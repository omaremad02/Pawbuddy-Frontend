...
const endpoints = {
  ...
  // adoption request
  GET_ALL_ADOPTION_REQUESTS: `${API_BASE_URL}/api/adoption/get-adoption-requests`,  // Endpoint to add a pet

  UPDATE_ADOPTION_REQUESTS:(id)=>  `${API_BASE_URL}/api/adoption/update-adoption-request/${id}`,  // Endpoint to add a pet
